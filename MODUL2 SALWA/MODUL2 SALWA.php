            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <input type="submit" class="btn btn-primary mb-3 mt-3 w-100" name= 'Hitung' value='hitung'>
                    </form>
                    <?php
                        ...
                        if ($hasil <= 18.4) {
                            $pesan = 'Status berat badanmu adalah Underweight';
                        } elseif ($hasil >= 18.5 && $hasil <= 24.9 ){
                            $pesan ='Status berat badanmu adalah Normal';
                        } elseif ($hasil >= 25.0 && $hasil <= 39.9 ){
                            $pesan ='Status berat badanmu adalah Overweight';
                        } else{
                            $pesan ='Status berat badanmu adalah Obes';
                        }
